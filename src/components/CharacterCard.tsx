...
export default function CharacterCard({ id, name }: CharacterCardProps) {
  return (
    <div className="group cursor-pointer bg-white/10 backdrop-blur-md border border-purple-500/20 rounded-xl p-6 hover:bg-white/15 hover:border-yellow-400/40 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-purple-500/25">
